...
export const handleExportPDF = async (columns, data, title, summary=null) => {
  ...
  // 🔹 Render optional summary block (if provided)
  if (summary && typeof summary === "object") {
    ...
    // Adjust table starting position based on summary length
    autoTable(doc, {
      headStyles: {
        fillColor: [0, 49, 118],
