  ...
  return (
    <>
      ...
      <div className="row m-0 p-3 pt-0">
        ...
        {suppliers && <div className='row m-0 p-3 justify-content-center'>
            <div className="col-md-9">
                <table className='table table-bordered borderedtable'>
                    ...
                    <tbody>
                        {suppliers.length === 0 && <tr><td colSpan={5}>NO DATA FOUND</td></tr>}
                        {suppliers.length > 0 && suppliers.map((supplier) => <tr>
                            <td>{count++}</td>
                            <td>{supplier.createdAt.slice(0, 10)}</td>
                            <td>{supplier.supplierCode}</td>
                            <td>{supplier.name}</td>
                            <td><EditVendorViewModal supplier={supplier}/></td>
                        </tr>)} 
                    </tbody>
                </table>
            </div>
